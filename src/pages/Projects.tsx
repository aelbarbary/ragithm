...
const projects = [
  {
    ...
    description: 'Python-based image recognition system using TensorFlow',
...
model = tf.keras.Sequential([
  ...
  },
  {
    ...
    description: 'Intelligent chatbot built with React and NLP',
    tech: ['React', 'TypeScript', 'NLP.js'],
    demoUrl: '#',
    codePreview: `
const ChatBot = () => {
